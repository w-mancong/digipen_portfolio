...
int main()//int argc, char **argv)
{
	...
	if (std::strcmp(test, "board3-2.txt") == 0 || std::strcmp(test, "board4-1.txt") == 0 || std::strcmp(test, "board4-2.txt") == 0 || std::strcmp(test, "board4-4.txt") == 0 || std::strcmp(test, "board5-1.txt") == 0)
	{
		SYMBOL_TYPE = Sudoku::SYM_LETTER;
	}
