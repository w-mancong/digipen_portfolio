#include <pch.h>
#include "L_CheckOnChef.h"

L_CheckOnChef::L_CheckOnChef() : timer(0.0f)
{}

void L_CheckOnChef::on_enter()
{
    ...
    targetPosition.x = MyVar::CELL_SIZE * 18.0f - MyVar::HALF_CELL_SIZE;
...
void L_CheckOnChef::on_update(float dt)
{
    display_leaf_text();
