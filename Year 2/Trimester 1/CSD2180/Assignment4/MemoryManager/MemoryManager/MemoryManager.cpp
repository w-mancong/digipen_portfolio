...
MemoryManager::MemoryManager(uint64_t total_bytes)
{
...
void* MemoryManager::allocate(uint64_t bytes)
{
...
void MemoryManager::Print(void* startAddress, uint64_t byteCount, bool allocated, std::ostream& out)
{
